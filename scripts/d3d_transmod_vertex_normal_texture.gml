/*
**  Usage:
**      d3d_transmod_vertex_normal_texture(ind, x,y,z, nx,ny,nz, 
**                                          xtex,ytex, nscale);
**
**  Arguments:
**      The first 9:    same as d3d_model_vertex_normal_texture ()       
...
*/
{
    ...
    d3d_model_vertex_normal_texture (argument0, vx, vy, vz, 
                                     n*nx, n*ny, n*nz, 
                                     argument7, argument8);         
}
